...
/**
 * Helper class containing methods executed for the serverless workflow scripts.
 */
public class QueryAnswerServiceScripts {
    ...
    public static void initializationScript(KogitoProcessContext kcontext) {
        ...
        QueryAnswerServiceHelper helper = Arc.container().instance(QueryAnswerServiceHelper.class).get();
        helper.registerQuery(workflowData, kcontext);
    }
